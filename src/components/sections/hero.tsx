    ...
    >
      <div className="flex flex-col items-start gap-4 flex-1">
        ...
        <MotionP
          ...
          variants={itemVariants}
        >
          I&apos;m a senior computer science student at BCIT specializing in
          full-stack web development. I build scalable applications and system
          integrations using TypeScript, Go, PostgreSQL, and AWS. My experience
          includes developing APIs with Go, Java, and Node.js, building React
          frontends, and working with real-time systems using WebSockets.
          I&apos;ve contributed to AI-powered applications and handled database
