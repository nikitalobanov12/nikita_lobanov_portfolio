  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-14 items-center px-4 mx-auto">
        <div className="flex">
          <Link href="/" className="mr-6 flex items-center space-x-2 font-bold transition-all hover:text-gray-700">
        ...
        <div className="md:hidden ml-auto">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[250px]">
              <DropdownMenuItem asChild className="py-3 text-base font-medium focus:bg-muted">
                <Link href="#about" className="cursor-pointer w-full">
                  About
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild className="py-3 text-base font-medium focus:bg-muted">
                <Link href="#experience" className="cursor-pointer w-full">
                  Experience
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild className="py-3 text-base font-medium focus:bg-muted">
        ...
        <nav className="hidden md:flex items-center space-x-6 text-sm font-medium flex-1 justify-end">
          ...
          <Link href="#projects" className="transition-all hover:text-gray-600">Projects</Link>
          <Link href="#contact" className="transition-all hover:text-gray-600">Contact</Link>
