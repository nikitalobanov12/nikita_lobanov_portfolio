...
export default function HeroSlideshow({ className, intervalMs = 4500 }: HeroSlideshowProps) {
	...
	return (
		<div className={cn('relative flex justify-center md:justify-end', className)}>
